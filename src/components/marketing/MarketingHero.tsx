...
export const MarketingHero: React.FC = () => {
  ...
  return (
    <section className="relative overflow-hidden bg-[#F0F7FB] border-b-2 border-[#D8E5EE] pt-14 pb-20">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 space-y-12 relative z-10">
        ...
        <div className="text-center max-w-4xl mx-auto space-y-6">
          ...
          <div className="pt-2 max-w-3xl mx-auto">
            <div className="bg-white border-2 border-[#D8E5EE] rounded-3xl p-5 shadow-sm space-y-3">
                ...
                <button
                  ...
                  className={`p-3.5 rounded-2xl border-2 text-left transition-all cursor-pointer flex flex-col justify-between ${
                    selectedPracticeType === 'pro'
                      ...
                      : 'border-[#D8E5EE] hover:border-[#08232C] bg-white'
                  }`}
                >
